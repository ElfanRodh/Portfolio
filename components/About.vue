    ...
    <div class="max-w-screen-2xl mx-auto pt-28 pb-10 px-4 sm:pt-24 sm:px-6 md:pt-16 md:pb-16 lg:pt-28 lg:px-8 xl:pt-28">
      <div class="sm:text-center lg:text-left z-0">
        <span class="before:block before:absolute before:left-0 before:-bottom-3 before:h-2 before:w-10 before:bg-gray-500 dark:before:bg-indigo-100 before:rounded-full relative inline-block">
          <span class="relative text-3xl font-semibold text-sky-600 my-3 font-mono">About Me</span>
        </span>
      </div>
      <figure class="md:flex rounded-xl p-8 md:p-0">
        ...
        <div class="pt-6 md:p-8 text-center md:text-left space-y-4">
          <div class="text-left mb-10">
            ...
            <p class="text-center md:text-left text-gray-500 dark:text-blue-50 leading-8 text-xl">
              <span>
                ...
                <br>
                I always looking for new challenges.
                <br>
                I'm passionate about building beautiful, responsive, and accessible websites and applications.
              </span>
            </p>
          ...
          <div class="text-center md:text-left mb-10">
            ...
            <span class="font-medium text-xl text-gray-500 dark:text-blue-50 block mb-2">Indonesia</span>

            <span class="font-bold text-blue-500">City: </span>
            <span class="font-medium text-xl text-gray-500 dark:text-blue-50 block mb-2">Bojonegoro</span>
          ...
          <!-- <blockquote>
            <p class="text-lg font-medium text-blue-50">
          ...
          <div class="mt-8 sm:mt-28 sm:flex sm:justify-center lg:justify-start">
            <div class="">
              <!-- <a href="#" class="font-bold w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-2xl bg-blue-100 shadow-lg shadow-neo-light-soft active:shadow-neo-light-soft-focus dark:shadow-neo-dark-soft dark:active:shadow-neo-dark-soft-focus dark:bg-gray-800 text-indigo-700 md:py-4 md:text-lg md:px-10">
                DOWNLOAD CV
              </a> -->
            </div>
          </div>
          ...
          <div class="pt-6 text-center md:text-left space-y-4">
            <div class="text-left mb-10">
              ...
              <div class="py-2 min-h-6">
                <p class="text-center md:text-left text-gray-500 dark:text-blue-50 leading-8 text-xl">
                  <span>
                    2019 - State Polytechnic of Malang (Bachelor of Informatics Engineering)
                  </span>
                </p>
                <div class="w-full md:w-1/2 h-1 mt-2 rounded-full bg-teal-500"></div>
              </div>
              <div class="py-2 min-h-6">
                <p class="text-center md:text-left text-gray-500 dark:text-blue-50 leading-8 text-xl">
                  <span>
                    2016 - Community Academy of Bojonegoro (Bachelor of Informatics Engineering)
                  </span>
                </p>
                <div class="w-full md:w-1/2 h-1 mt-2 rounded-full bg-teal-500"></div>
              </div>
        ...
        <div class="w-full md:w-1/2 px-3">
          <div class="pt-6 text-center md:text-left space-y-4">
            <div class="text-left mb-10">
              ...
              <div class="py-2">
                <p class="text-center md:text-left text-gray-500 dark:text-blue-50 leading-8 text-xl flex">
                  <span class="w-5/5 md:w-4/5">
                    2019 - Pengembangan Library Sistem Pemeringkat Otomatis Berbasis Kata Sifat
                  </span>
                  <span class="w-5/5 md:w-1/5">
                    <a href="https://scholar.google.com/citations?view_op=view_citation&hl=id&user=DDX4ay8AAAAJ&cstart=20&pagesize=80&alert_preview_top_rm=2&authuser=3&citation_for_view=DDX4ay8AAAAJ:qUcmZB5y_30C" target="_blank">
